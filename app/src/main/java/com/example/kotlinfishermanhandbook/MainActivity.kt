...
class MainActivity : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // list.add(ListItem(R.drawable.som,"Сом","чапрча"))
       // list.add(ListItem(R.drawable.nalim,"Налим","чварчпрча"))
       // list.add(ListItem(R.drawable.shuca,"Щука","ччача"))
       // list.add(ListItem(R.drawable.caras,"Карась","чвапчапрча"))
        rcView.hasFixedSize()
